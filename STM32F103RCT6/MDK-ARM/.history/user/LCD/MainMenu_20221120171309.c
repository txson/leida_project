...
//		
		...
		for(tmp_i = 0 ; tmp_i < strlen(baifenbi) ; tmp_i++)
		{
			...
			if(baifenbi[tmp_i] == '.')
			{
				...
				/*显示传感器数值*/
				disp_blink_16x8(1,72 + tmp_i * 8,clear);
				disp_blink_16x8(1,72+ tmp_i * 8,disp_cursor_16x8[10]);
			}
			else 
			{
				/*显示传感器数值*/
				disp_blink_16x8(1,72 + tmp_i * 8,clear);
				disp_blink_16x8(1,72 + tmp_i * 8,disp_cursor_16x8[baifenbi[tmp_i] - '0']);
			}
