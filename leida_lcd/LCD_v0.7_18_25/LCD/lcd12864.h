...
#define Rom_OUT HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_2)
...
/***********************************************************************************************
*函数名 ：		display_graphic_16x16
*函数功能描述 ：显示16*16的点阵图像、汉字、生僻字或16*16点阵的其它图标
*函数参数 ：	无
*函数返回值 ：	无
*作者 ：		
*函数创建日期 ：2022-08-06
...
/***********************************************************************************************
*函数名 ：		display_graphic_8x16
*函数功能描述 ：显示8*16点阵图像、ASCII、或8*16点阵的自造字符、其它图标
*函数参数 ：	无
*函数返回值 ：	无
*作者 ：		
*函数创建日期 ：2022-08-06
...
/***********************************************************************************************
*函数名 ：		display_graphic_5x8
*函数功能描述 ：显示5*8点阵图像、ASCII、或8*16点阵的自造字符、其它图标
*函数参数 ：	无
*函数返回值 ：	无
*作者 ：		
*函数创建日期 ：2022-08-06
